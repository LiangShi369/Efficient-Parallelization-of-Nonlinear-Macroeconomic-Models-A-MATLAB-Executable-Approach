function [q,bp,vp,def,totaltime,avgtime] = solver_divide_cuda(b,z,m,pdf,para)
...
coder.gpu.kernelfun;
    ...
    Vrow = coder.nullcopy(zeros(1, nb)) ;
    bprow = coder.nullcopy(zeros(1, nb)) ;
    defrow = coder.nullcopy(zeros(1, nb)) ;
    ...
    L = coder.nullcopy(zeros(stackSize,1)) ; 
    U = coder.nullcopy(zeros(stackSize,1)) ;
...
coder.gpu.kernelfun;
    ...
    coder.gpu.iterations(25); % avg num of iterations
