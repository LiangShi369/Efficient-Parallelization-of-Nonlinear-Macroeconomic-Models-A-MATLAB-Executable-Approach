 ...
 *
 * solver_bruteforce_data.c
 *
 * Code generation for function 'solver_bruteforce_data'
 *
 */
...
emlrtContext emlrtContextGlobal = {
    ...
    NULL,                                                 /* fErrorFunction */
    "solver_bruteforce",                                  /* fFunctionName */
    NULL,                                                 /* fRTCallStack */
    false,                                                /* bDebugMode */
...
omp_nest_lock_t solver_bruteforce_nestLockGlobal;
...
/* End of code generation (solver_bruteforce_data.c) */
