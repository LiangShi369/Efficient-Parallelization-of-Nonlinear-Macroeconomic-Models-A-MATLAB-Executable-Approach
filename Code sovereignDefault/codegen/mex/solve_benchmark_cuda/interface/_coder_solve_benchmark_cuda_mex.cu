                 ...
                 const mxArray *prhs[])
{
  ...
  try {
    unsafe_solve_benchmark_cuda_mexFunction(nlhs, plhs, nrhs, prhs);
...
void unsafe_solve_benchmark_cuda_mexFunction(int32_T nlhs, mxArray *plhs[9],
                                             int32_T nrhs,
                                             const mxArray *prhs[5])
{
  ...
  // Call the function.
  solve_benchmark_cuda_api(prhs, nlhs, outputs);
