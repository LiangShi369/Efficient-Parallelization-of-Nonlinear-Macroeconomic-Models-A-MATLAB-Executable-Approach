 ...
 *
 * _coder_solver_bf_parfor2_api.c
 *
 * Code generation for function '_coder_solver_bf_parfor2_api'
 *
 */
...
static const mxArray *b_emlrt_marshallOut(const real_T u[125000]);

static real_T (*c_emlrt_marshallIn(const emlrtStack *sp, const mxArray *nullptr,
                                   const char_T *identifier))[200];

static const mxArray *c_emlrt_marshallOut(const boolean_T u[125000]);
...
void solver_bf_parfor2_api(solver_bf_parfor2StackData *SD,
                           ...
                           const mxArray *plhs[6])
{
  ...
  solver_bf_parfor2(SD, &st, *b, *z, *m, *pdf, &para, *q, *bp, *vp, *def,
                    &totaltime, &avgtime);
...
/* End of code generation (_coder_solver_bf_parfor2_api.c) */
