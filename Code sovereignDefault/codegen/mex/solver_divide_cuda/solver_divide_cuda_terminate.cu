...
//
// solver_divide_cuda_terminate.cu
//
// Code generation for function 'solver_divide_cuda_terminate'
//
...
void solver_divide_cuda_atexit()
{
...
void solver_divide_cuda_terminate()
{
  checkCudaError(cudaGetLastError());
  emlrtDestroyRootTLS(&emlrtRootTLSGlobal);
}

// End of code generation (solver_divide_cuda_terminate.cu)
