...
//
// _coder_solver_divide_cuda_api.cu
//
// Code generation for function '_coder_solver_divide_cuda_api'
//
...
void solver_divide_cuda_api(const mxArray *const prhs[5], int32_T nlhs,
                            const mxArray *plhs[6])
{
  ...
  def = (real_T(*)[250000])mxMalloc(sizeof(real_T[250000]));
  ...
  solver_divide_cuda(*b, *z, *m, *pdf, &para, *q, *bp, *vp, *def, &totaltime,
                     &avgtime);
...
// End of code generation (_coder_solver_divide_cuda_api.cu)
