 ...
 *
 * solver_bf_parfor_data.c
 *
 * Code generation for function 'solver_bf_parfor_data'
 *
 */
...
emlrtContext emlrtContextGlobal = {
    ...
    NULL,                                                 /* fErrorFunction */
    "solver_bf_parfor",                                   /* fFunctionName */
    NULL,                                                 /* fRTCallStack */
    false,                                                /* bDebugMode */
...
omp_nest_lock_t solver_bf_parfor_nestLockGlobal;
...
/* End of code generation (solver_bf_parfor_data.c) */
