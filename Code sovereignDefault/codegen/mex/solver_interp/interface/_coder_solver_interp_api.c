 ...
 *
 * _coder_solver_interp_api.c
 *
 * Code generation for function '_coder_solver_interp_api'
 *
 */
...
static const mxArray *b_emlrt_marshallOut(real_T u[50000]);

static real_T (*c_emlrt_marshallIn(const emlrtStack *sp, const mxArray *nullptr,
                                   const char_T *identifier))[80];

static const mxArray *c_emlrt_marshallOut(boolean_T u[50000]);
...
static const mxArray *b_emlrt_marshallOut(real_T u[50000])
{
  ...
  static const int32_T iv1[2] = {625, 80};
  const mxArray *m;
  const mxArray *y;
  void *existingData;
  y = NULL;
...
void solver_interp_api(solver_interpStackData *SD, const mxArray *const prhs[5],
                       int32_T nlhs, const mxArray *plhs[6])
{
  ...
  q = (real_T(*)[50000])mxMalloc(sizeof(real_T[50000]));
  bp = (real_T(*)[50000])mxMalloc(sizeof(real_T[50000]));
  vp = (real_T(*)[50000])mxMalloc(sizeof(real_T[50000]));
  def = (boolean_T(*)[50000])mxMalloc(sizeof(boolean_T[50000]));
  ...
  solver_interp(SD, &st, *b, *z, *m, *pdf, &para, *q, *bp, *vp, *def,
                &totaltime, &avgtime);
...
/* End of code generation (_coder_solver_interp_api.c) */
