 ...
 *
 * solver_interp_data.c
 *
 * Code generation for function 'solver_interp_data'
 *
 */
...
omp_nest_lock_t solver_interp_nestLockGlobal;
...
/* End of code generation (solver_interp_data.c) */
