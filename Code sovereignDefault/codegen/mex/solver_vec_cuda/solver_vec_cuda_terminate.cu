...
//
// solver_vec_cuda_terminate.cu
//
// Code generation for function 'solver_vec_cuda_terminate'
//
...
void solver_vec_cuda_terminate()
{
  checkCudaError(cudaGetLastError());
  emlrtDestroyRootTLS(&emlrtRootTLSGlobal);
}

// End of code generation (solver_vec_cuda_terminate.cu)
