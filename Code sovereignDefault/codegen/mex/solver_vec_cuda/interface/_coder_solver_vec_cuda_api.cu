...
//
// _coder_solver_vec_cuda_api.cu
//
// Code generation for function '_coder_solver_vec_cuda_api'
//
...
static const mxArray *emlrt_marshallOut(real_T u[125000]);
...
void solver_vec_cuda_api(const mxArray *const prhs[5], int32_T nlhs,
                         const mxArray *plhs[6])
{
  ...
  solver_vec_cuda(*b, *z, *m, *pdf, &para, *q, *bp, *vp, *def, &totaltime,
                  &avgtime);
...
// End of code generation (_coder_solver_vec_cuda_api.cu)
