...
static emlrtRTEInfo lb_emlrtRTEI = {
    1,                                   /* lineNo */
    1,                                   /* colNo */
    "_coder_solve_benchmark_parfor_api", /* fName */
    ""                                   /* pName */
};
...
void solve_benchmark_parfor_api(const mxArray *const prhs[5], int32_T nlhs,
                                const mxArray *plhs[9])
{
  ...
  *(real_T **)&b_data =
  ...
  solve_benchmark_parfor(&st, *z_data, &z_size, *m_data, &m_size, *b_data,
                         &b_size, pdf, *para, vp, *vd_data, &vd_size, q, bp,
                         *bpr_data, &bpr_size, b_default, rr, &totaltime,
                         &avgtime);
