 ...
 *
 * _coder_solver_divide_api.c
 *
 * Code generation for function '_coder_solver_divide_api'
 *
 */
...
void solver_divide_api(solver_divideStackData *SD, const mxArray *const prhs[5],
                       int32_T nlhs, const mxArray *plhs[6])
{
  ...
  solver_divide(SD, &st, *b, *z, *m, *pdf, &para, *q, *bp, *vp, *def,
                &totaltime, &avgtime);
...
/* End of code generation (_coder_solver_divide_api.c) */
