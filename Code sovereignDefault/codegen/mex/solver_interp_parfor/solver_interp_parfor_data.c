 ...
 *
 * solver_interp_parfor_data.c
 *
 * Code generation for function 'solver_interp_parfor_data'
 *
 */
...
emlrtContext emlrtContextGlobal = {
    ...
    NULL,                                                 /* fErrorFunction */
    "solver_interp_parfor",                               /* fFunctionName */
    NULL,                                                 /* fRTCallStack */
    false,                                                /* bDebugMode */
...
omp_nest_lock_t solver_interp_parfor_nestLockGlobal;
...
/* End of code generation (solver_interp_parfor_data.c) */
