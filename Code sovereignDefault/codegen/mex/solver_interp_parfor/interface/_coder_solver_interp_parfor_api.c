 ...
 *
 * _coder_solver_interp_parfor_api.c
 *
 * Code generation for function '_coder_solver_interp_parfor_api'
 *
 */
...
void solver_interp_parfor_api(solver_interp_parforStackData *SD,
                              ...
                              const mxArray *plhs[6])
{
  ...
  def = (real_T(*)[50000])mxMalloc(sizeof(real_T[50000]));
  ...
  solver_interp_parfor(SD, &st, *b, *z, *m, *pdf, &para, *q, *bp, *vp, *def,
                       &totaltime, &avgtime);
...
/* End of code generation (_coder_solver_interp_parfor_api.c) */
