 ...
 *
 * _coder_solver_divide_parfor_api.c
 *
 * Code generation for function '_coder_solver_divide_parfor_api'
 *
 */
...
void solver_divide_parfor_api(solver_divide_parforStackData *SD,
                              ...
                              const mxArray *plhs[6])
{
  ...
  solver_divide_parfor(SD, &st, *b, *z, *m, *pdf, &para, *q, *bp, *vp, *def,
                       &totaltime, &avgtime);
...
/* End of code generation (_coder_solver_divide_parfor_api.c) */
