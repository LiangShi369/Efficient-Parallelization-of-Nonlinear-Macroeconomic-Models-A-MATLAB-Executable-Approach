 ...
 *
 * solver_divide_parfor_data.c
 *
 * Code generation for function 'solver_divide_parfor_data'
 *
 */
...
emlrtContext emlrtContextGlobal = {
    ...
    NULL,                                                 /* fErrorFunction */
    "solver_divide_parfor",                               /* fFunctionName */
    NULL,                                                 /* fRTCallStack */
    false,                                                /* bDebugMode */
...
omp_nest_lock_t solver_divide_parfor_nestLockGlobal;
...
/* End of code generation (solver_divide_parfor_data.c) */
