function [q,bp,vp,def,totaltime,avgtime] = solver_interp_parfor(b,z,m,pdf,para)
...
%% SUBFUNCTIONS 
function F = rhs_bellman(bprime,c_vec,b_grid,evp_s)
...
if c1 <= 0
    ...
    F = - (c1^(1-eta)-1)/(1-eta) - interp1_scal(b_grid, evp_s, bprime)  ;
end
end
