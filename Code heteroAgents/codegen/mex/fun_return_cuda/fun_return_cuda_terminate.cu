...
//
// fun_return_cuda_terminate.cu
//
// Code generation for function 'fun_return_cuda_terminate'
//
...
void fun_return_cuda_terminate()
{
  checkCudaError(cudaGetLastError());
  emlrtDestroyRootTLS(&emlrtRootTLSGlobal);
}

// End of code generation (fun_return_cuda_terminate.cu)
