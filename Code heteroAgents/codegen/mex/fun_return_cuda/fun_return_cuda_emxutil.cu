                              ...
                              const emlrtRTEInfo *srcLocation)
{
  ...
  for (i = 0; i < emxArray->numDimensions; i++) {
    newNumel = static_cast<int32_T>(emlrtSizeMulR2012b(
        static_cast<size_t>(static_cast<uint32_T>(newNumel)),
        static_cast<size_t>(static_cast<uint32_T>(emxArray->size[i])),
...
// End of code generation (fun_return_cuda_emxutil.cu)
