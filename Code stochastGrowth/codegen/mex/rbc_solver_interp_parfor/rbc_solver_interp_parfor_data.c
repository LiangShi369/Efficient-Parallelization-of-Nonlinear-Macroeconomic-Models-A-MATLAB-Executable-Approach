 ...
 *
 * rbc_solver_interp_parfor_data.c
 *
 * Code generation for function 'rbc_solver_interp_parfor_data'
 *
 */
...
emlrtContext emlrtContextGlobal = {
    ...
    NULL,                                                 /* fErrorFunction */
    "rbc_solver_interp_parfor",                           /* fFunctionName */
    NULL,                                                 /* fRTCallStack */
    false,                                                /* bDebugMode */
...
omp_nest_lock_t rbc_solver_interp_parfor_nestLockGlobal;
...
/* End of code generation (rbc_solver_interp_parfor_data.c) */
