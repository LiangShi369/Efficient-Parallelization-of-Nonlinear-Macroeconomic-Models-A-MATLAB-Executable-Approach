...
//
// rbc_solver_interp_cuda_terminate.cu
//
// Code generation for function 'rbc_solver_interp_cuda_terminate'
//
...
void rbc_solver_interp_cuda_atexit()
{
...
void rbc_solver_interp_cuda_terminate()
{
  checkCudaError(cudaGetLastError());
  emlrtDestroyRootTLS(&emlrtRootTLSGlobal);
}

// End of code generation (rbc_solver_interp_cuda_terminate.cu)
